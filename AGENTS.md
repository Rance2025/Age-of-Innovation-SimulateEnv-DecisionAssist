...
### 6. Git 版本与版本变更记录维护
- **每次进行 Git 提交前，必须先修改版本变更文档 `docs/version-change-log.md`，再执行 Git 操作**
- **每次完成任何代码修改（无论大小）后，必须立即更新版本变更文档 `docs/version-change-log.md`，这是强制步骤，不得遗漏**
- 每次进行任何可感知的小更新、修复、样式调整、交互调整或数据结构调整后，都必须同步维护版本变更文档：`docs/version-change-log.md`
- Git 提交版本名默认使用纯数字版本号，例如：`0.9.5.4`
- 如我未强调版本号，你只需要在最后面的一个编号上 +1 即可；本次提交版本号为 `0.9.5.11`
